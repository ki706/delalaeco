...
class ContactAdmin(admin.ModelAdmin):
    ...
    list_display = ('id', 'first_name', 'last_name','phone', 'email', 'car_title','car_id', 'city', 'message_to_customr1','create_date')
...
class ServiceContactAdmin(admin.ModelAdmin):
    list_display = ('id', 'first_name', 'last_name','phone', 'email', 'car_title','ser_id', 'city', 'message_to_customr1','create_date')
    list_display_links = ('id', 'first_name', 'last_name')
    search_fields = ('first_name', 'last_name', 'email', 'car_title')
    list_per_page = 25
